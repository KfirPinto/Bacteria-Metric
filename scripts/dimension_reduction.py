...
if __name__ == "__main__":
    embedding_file = "/home/bcrlab/barsapi1/metric/Bacteria-Metric/data/HMP_2012_stool/raw/filtered_tensor.npy"
    metadata_file = "/home/bcrlab/barsapi1/metric/Bacteria-Metric/data/HMP_2012_stool/raw/filtered_query_entries.npy"

    # Run all three methods
    for method in ["PCA", "PCoA", "tSNE"]:
        for level in ["phylum", "class", "order", "family", "genus"]:
            main(embedding_file, metadata_file, level, method=method, 
                 save_dir=f"/home/bcrlab/barsapi1/metric/Bacteria-Metric/results/Shani_model/{method.lower()}/{level}")